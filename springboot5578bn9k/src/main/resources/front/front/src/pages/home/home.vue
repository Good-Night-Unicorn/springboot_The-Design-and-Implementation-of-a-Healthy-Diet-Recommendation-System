	...
	<div class="home-preview">
		...
		<div id="animate_newsnews" class="news animate__animated">
			<div class="news_title_box">
				<span class="news_title">消息推送</span>
		...
		<!-- 新闻资讯 -->
		<!-- 商品推荐 -->
		<div id="animate_recommendcaipinxinxi" class="recommend animate__animated">
			<div class="recommend_title_box">
				<span class="recommend_title">菜品信息推荐</span>
				<span class="recommend_subhead">{{'caipinxinxi'.toUpperCase()}} RECOMMEND</span>
			</div>
			<div v-if="caipinxinxiRecommend.length" class="list list12 index-pv1 list12caipinxinxi">
				<div class="list-body">
					<div class="item list-item animation-box" v-for="item,index in caipinxinxiRecommend" :key="index" @click="toDetail('caipinxinxiDetail', item)">
						<img :name="item.id" v-if="preHttp(item.caipintupian)&&preHttp2(item.caipintupian)" :src="item.caipintupian" alt="" />
						<img :name="item.id" v-else-if="preHttp(item.caipintupian)" :src="item.caipintupian.split(',')[0]" alt="" />
						<img :name="item.id" v-else :src="baseUrl + (item.caipintupian?item.caipintupian.split(',')[0]:'')" alt="" />
						<div class="name">{{item.caipinmingcheng}}</div>
						<div class="name">{{item.caipinleixing}}</div>
					</div>
				</div>
			</div>
			<div class="moreBtn" @click="moreBtn('caipinxinxi')">
				<span class="text">查看更多</span>
				<i class="icon iconfont icon-gengduo1"></i>
			</div>
		</div>
		...
		methods: {
			...
			handleScroll() {
				let arr = [
					...
					{id:'animate_recommendcaipinxinxi',css:'animate__backInRight'},
