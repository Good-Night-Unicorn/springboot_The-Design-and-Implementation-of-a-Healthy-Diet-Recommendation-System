	...
	<!--  -->
		<div class="breadcrumb-preview">
			<el-breadcrumb :separator="'-'">
				...
				<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" :to="'/index/yinshijilu?centerType=' + (centerType?'1':'0')"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">餐次</div>
						<div class="text "  >{{detail.canci}}</div>
					</div>
					<div class="item">
						<div class="lable">食物种类</div>
						<div class="text "  >{{detail.shiwuzhonglei}}</div>
					</div>
					<div class="item">
						<div class="lable">摄入量</div>
						<div class="text "  >{{detail.sheruliang}}</div>
					</div>
					<div class="item">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('yinshijilu','修改')&&detail.sfsh!='是'&&detail.sfsh!='否' " @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('yinshijilu','删除')" @click="delClick">删除</el-button>
						<el-button class="auditBtn" v-if="btnAuth('yinshijilu','审核') && (detail.sfsh=='待审核'||!detail.sfsh)" @click="onSH" type="warning">审核</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 删除
			async delClick(){
				await this.$confirm('是否删除此饮食记录？') .then(_ => {
