	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="餐次" prop="canci" >
				...
				<el-form-item v-else class="input" label="餐次" prop="canci" >
					<el-input v-model="ruleForm.canci"
						placeholder="餐次" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="食物种类" prop="shiwuzhonglei" >
					<el-input v-model="ruleForm.shiwuzhonglei" placeholder="食物种类" clearable  :readonly="ro.shiwuzhonglei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="食物种类" prop="shiwuzhonglei" >
					<el-input v-model="ruleForm.shiwuzhonglei" placeholder="食物种类" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="摄入量" prop="sheruliang" >
					<el-input v-model="ruleForm.sheruliang" placeholder="摄入量" clearable  :readonly="ro.sheruliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="摄入量" prop="sheruliang" >
					<el-input v-model="ruleForm.sheruliang" placeholder="摄入量" readonly></el-input>
				</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='shiwuzhonglei'){
							this.ruleForm.shiwuzhonglei = obj[o];
							this.ro.shiwuzhonglei = true;
							continue;
						}
						if(o=='sheruliang'){
							this.ruleForm.sheruliang = obj[o];
							this.ro.sheruliang = true;
							continue;
						}
						if(o=='tupian'){
