		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0px 20px 0","background":"none"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000000","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' class="item-label">菜品名称</label>
						<el-input v-model="searchForm.caipinmingcheng" placeholder="菜品名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}' class="select" label="菜品类型" prop="caipinleixing">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000000","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' class="item-label">菜品类型</label>
						<el-select clearable v-model="searchForm.caipinleixing" placeholder="请选择菜品类型" >
							<el-option v-for="(item,index) in caipinleixingOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000000","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' class="item-label">所需食材</label>
						<el-input v-model="searchForm.suoxushicai" placeholder="所需食材" @keydown.enter.native="search()" clearable></el-input>
					</div>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column  :resizable='true' prop="caipintupian" width="200" label="菜品图片">
						<template slot-scope="scope">
							<div v-if="scope.row.caipintupian">
								<img v-if="scope.row.caipintupian.substring(0,4)=='http'&&scope.row.caipintupian.split(',w').length>1" :src="scope.row.caipintupian" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.caipintupian)">
								<img v-else-if="scope.row.caipintupian.substring(0,4)=='http'" :src="scope.row.caipintupian.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.caipintupian.split(',')[0])">
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.caipinleixing!='' && this.searchForm.caipinleixing!=undefined){
 				...
 				if(this.searchForm.suoxushicai!='' && this.searchForm.suoxushicai!=undefined){
					params['suoxushicai'] = '%' + this.searchForm.suoxushicai + '%'
				}
