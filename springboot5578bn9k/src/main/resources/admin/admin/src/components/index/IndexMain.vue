<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"70px 0 0 200px","margin":"0","position":"relative","background":"#f5f5f5","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0","borderColor":"#A8A8A8","alignItems":"center","color":"#000000","display":"flex","justifyContent":"space-between","top":"0","left":"0","background":"#fff","borderWidth":"0 0 1px 0","width":"100%","fontSize":"16px","position":"fixed","borderStyle":"solid","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 15px","margin":"0","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"14px","position":"fixed","borderStyle":"solid","height":"50px","zIndex":"2"}' class="bread-crumbs"></bread-crumbs>
