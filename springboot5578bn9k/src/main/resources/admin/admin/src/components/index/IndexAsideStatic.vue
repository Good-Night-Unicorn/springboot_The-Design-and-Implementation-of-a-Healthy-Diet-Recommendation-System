...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip {
		...
		font-size: inherit;
		line-height: 73px;
		background-image: url(http://codegen.caihongy.cn/20241009/663a719614b34a03a6f3308c59782723.png) ;
		position: relative;
		height: 73px;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
		...
		background: url(http://codegen.caihongy.cn/20241010/c6616bad74b447a3b22e68e6096f890f.png)  no-repeat  center center/  100% 100%,#348CB4 !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other /deep/ .el-submenu__title {
		...
		background-image: url(http://codegen.caihongy.cn/20241009/663a719614b34a03a6f3308c59782723.png)  !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		...
		margin: 0 8px !important;
		color: #fff !important;
		background: linear-gradient( 134deg, #7FE7EB 0%, #57CAFF 100%) !important;
		line-height: 40px !important;
		height: 40px !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.home>.el-tooltip:hover {
		border-radius: 10px ;
		background: url(http://codegen.caihongy.cn/20241010/c6616bad74b447a3b22e68e6096f890f.png)  no-repeat  center center/  100% 100%,#348CB4;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		...
		margin: 0 8px;
		color: #fff;
		background: linear-gradient( 134deg, #7FE7EB 0%, #57CAFF 100%);
		line-height: 40px;
		height: 40px;
	}
