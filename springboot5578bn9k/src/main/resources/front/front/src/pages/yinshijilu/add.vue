<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="餐次" prop="canci">
			...
			<el-form-item class="add-item" label="食物种类" prop="shiwuzhonglei">
				<el-input v-model="ruleForm.shiwuzhonglei" 
					placeholder="食物种类" clearable :disabled=" false  ||ro.shiwuzhonglei"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="摄入量" prop="sheruliang">
				<el-input v-model="ruleForm.sheruliang" 
					placeholder="摄入量" clearable :disabled=" false  ||ro.sheruliang"></el-input>
			</el-form-item>
			...
			async onSubmit() {
				...
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`yinshijilu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
