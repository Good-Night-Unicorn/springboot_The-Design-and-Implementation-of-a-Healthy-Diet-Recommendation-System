<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('eshianyycf','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{eshianyycfCount}}</div>
					<div class="name">营养成份总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<el-dialog :visible.sync="newsVisible" title="消息推送" :append-to-body="true" width="60%">
		...
		<!-- 5 -->
		<div class="type5">
			<div id="eshianyycfChart1" class="echarts1 animate__animated" v-if="isAuth('eshianyycf','首页统计')"></div>
			<div id="eshianyycfChart2" class="echarts2 animate__animated" v-if="isAuth('eshianyycf','首页统计')"></div>
			<div id="eshianyycfChart3" class="echarts3 animate__animated" v-if="isAuth('eshianyycf','首页统计')"></div>
			<div id="eshianyycfChart4" class="echarts4 animate__animated" v-if="isAuth('eshianyycf','首页统计')"></div>
			<div id="eshianyycfChart5" class="echarts5 animate__animated" v-if="isAuth('eshianyycf','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('eshianyycf','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'eshianyycfChart1',css:'animate__fadeInUp'},
				{id:'eshianyycfChart2',css:'animate__fadeInUp'},
				{id:'eshianyycfChart3',css:'animate__fadeInUp'},
				{id:'eshianyycfChart4',css:'animate__fadeInUp'},
				{id:'eshianyycfChart5',css:'animate__fadeInUp'},
			]
