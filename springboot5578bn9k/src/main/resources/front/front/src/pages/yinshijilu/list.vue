		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-select v-model="formSearch.canci" placeholder="请选择餐次" :clearable="true">
						<el-option v-for="(item, index) in canciOptions" :key="index" :label="item" :value="item"></el-option>
					</el-select>
				</el-form-item>
				...
				<el-button class="list-add-btn" v-if="btnAuth('yinshijilu','新增')" type="primary" @click="add('/index/yinshijiluAdd')">
			...
			<div class="list">
				...
				<div class="list1 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
						...
						<div class="name">日期:{{item.riqi}}</div>
						<div class="name">餐次:{{item.canci}}</div>
						<div class="time_item">
